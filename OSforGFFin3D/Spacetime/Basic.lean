...
/-!
# Basic Definitions (d = 3)

Core type definitions for the 3D formalization:

- `SpaceTime` = EuclideanSpace ℝ (Fin 3), the Euclidean 3-space ℝ³
...
/-- Spacetime dimension for the 3D port (Euclidean ℝ³). -/
